...
DATA_PATH = 'D:\CS760\ctr_cvr\data.txt'
...
def _generate_historical_convrate(df):
    ...
    col_list = [(['item_id'], 'item_convrate'), (['user_age_level', 'item_id'], 'age_item_convrate'),
                (['user_gender_id', 'item_id'], 'gender_item_convrate'), (['item_brand_id'], 'brand_convrate'),
                ]
...
def generate_dataset(enhance=False):
    ...
    if enhance:
        ...
        CONTINUOUS_FEATURES.extend(['item_convrate', 'age_item_convraterate', 'gender_item_convrate', 'brand_convrate',
